...
class Model(SQLModel, table=True):
    ...
    channel_id: str = Field(foreign_key="channel.id", ondelete="CASCADE", index=True)
    ...
    is_free: Optional[bool] = Field(default=None, index=True)
    ...
    health_status: str = Field(default="unknown", index=True)          # healthy / slow / down / unknown
